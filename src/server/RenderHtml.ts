...
export async function renderHtmlContent(htmlPath: string): Promise<string> {
  ...
  return ejs.render(htmlContent, {
    ...
    faviconHref: buildAssetUrl("images/WaraxisMark.svg", assetManifest, cdnBase),
    ...
    desktopLogoImageUrl: buildAssetUrl(
      "images/WaraxisLogo.svg",
      assetManifest,
      cdnBase,
    ),
    mobileLogoImageUrl: buildAssetUrl("images/WaraxisMark.svg", assetManifest, cdnBase),
  });
}
